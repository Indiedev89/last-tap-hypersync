...
CREATE POLICY "Anon can read tapped_events" ON public.tapped_events FOR SELECT TO anon USING (true);
CREATE POLICY "Service roles full access tapped_events" ON public.tapped_events FOR ALL TO service_role, postgres USING (true) WITH CHECK (true);
CREATE POLICY "Anon can read round_ended_events" ON public.round_ended_events FOR SELECT TO anon USING (true);
CREATE POLICY "Service roles full access round_ended_events" ON public.round_ended_events FOR ALL TO service_role, postgres USING (true) WITH CHECK (true);
